...
async function getLatestRelease() {
    try {
        const response = await fetch('https://api.github.com/repos/gaizhenbiao/tecdochatgpt/releases/latest');
        if (!response.ok) {
    ...
    try {
        ...
        if (currentVersion) {
            ...
            if (latestVersionTime) {
                const latestVersionInfo = `<a href="https://github.com/gaizhenbiao/tecdochatgpt/releases/latest" target="_blank" id="latest-version-title" style="text-decoration: none;">${latestVersion}</a>`
                const manualUpdateInfo = `<a href="https://github.com/GaiZhenbiao/tecdoChatGPT/wiki/使用教程#手动更新" target="_blanks" style="text-decoration: none;">manual update</a>`
...
function getUpdateInfo() {
    window.open('https://github.com/gaizhenbiao/tecdochatgpt/releases/latest', '_blank');
    closeUpdateToast();
}

var updateSpinner = null;

function bgUpdatetecdo() {
    updatetecdoBtn.click();
