...
function addtecdoButton(botElement) {
    ...
    if (!rawMessage) { // 如果没有 raw message，说明是早期历史记录，去除按钮
        // var buttons = botElement.querySelectorAll('button.tecdo-btn');
    ...
    copyButton.classList.add('tecdo-btn');
    ...
    toggleButton.classList.add('tecdo-btn');
...
function setLatestMessage() {
    var latestMessage = gradioApp().querySelector('#tecdo-chatbot > .wrapper > .wrap > .message-wrap .message.bot.latest');
...
function addLatestMessageButtons(botElement) {
    ...
    regenerateButton.classList.add('tecdo-btn');
    ...
    deleteButton.classList.add('tecdo-btn');
    ...
    likeButton.classList.add('tecdo-btn');
    ...
    dislikeButton.classList.add('tecdo-btn');
